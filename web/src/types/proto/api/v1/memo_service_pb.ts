...
/**
 * @generated from message memos.api.v1.PreviewMemoImportRequest
 */
export type PreviewMemoImportRequest = Message<"memos.api.v1.PreviewMemoImportRequest"> & {
  /**
...
/**
 * Describes the message memos.api.v1.PreviewMemoImportRequest.
 * Use `create(PreviewMemoImportRequestSchema)` to create a new message.
 */
export const PreviewMemoImportRequestSchema: GenMessage<PreviewMemoImportRequest> = /*@__PURE__*/
  messageDesc(file_api_v1_memo_service, 33);

/**
 * @generated from message memos.api.v1.ImportMemoExportRequest
 */
export type ImportMemoExportRequest = Message<"memos.api.v1.ImportMemoExportRequest"> & {
  /**
   * Required. The unmodified UTF-8 JSON bytes from a MemoArk export file.
   *
   * @generated from field: bytes data = 1;
...
/**
 * Describes the message memos.api.v1.ImportMemoExportRequest.
 * Use `create(ImportMemoExportRequestSchema)` to create a new message.
 */
export const ImportMemoExportRequestSchema: GenMessage<ImportMemoExportRequest> = /*@__PURE__*/
...
export type MemoImportIssue = Message<"memos.api.v1.MemoImportIssue"> & {
   ...
   *
   * @generated from field: int32 record_index = 1;
   */
  recordIndex: number;
   ...
   *
   * @generated from field: memos.api.v1.MemoImportIssueKind kind = 3;
   */
  kind: MemoImportIssueKind;
...
/**
 * @generated from message memos.api.v1.MemoImportSkippedCounts
 */
export type MemoImportSkippedCounts = Message<"memos.api.v1.MemoImportSkippedCounts"> & {
  /**
   * @generated from field: int32 attachments = 1;
   */
  attachments: number;

  /**
   * @generated from field: int32 comments = 2;
   */
  comments: number;

  /**
   * @generated from field: int32 relations = 3;
   */
  relations: number;

  /**
   * @generated from field: int32 reactions = 4;
   */
  reactions: number;

  /**
   * @generated from field: int32 locations = 5;
   */
  locations: number;

  /**
   * @generated from field: int32 settings = 6;
   */
  settings: number;
};

/**
 * Describes the message memos.api.v1.MemoImportSkippedCounts.
 * Use `create(MemoImportSkippedCountsSchema)` to create a new message.
 */
export const MemoImportSkippedCountsSchema: GenMessage<MemoImportSkippedCounts> = /*@__PURE__*/
  messageDesc(file_api_v1_memo_service, 36);

/**
 * @generated from message memos.api.v1.MemoImportPreview
 */
export type MemoImportPreview = Message<"memos.api.v1.MemoImportPreview"> & {
  /**
   * Whether the document envelope is a valid MemoArk v1 export.
   *
   * @generated from field: bool envelope_valid = 1;
   */
   ...
   *
   * @generated from field: bool can_import = 2;
   */
  canImport: boolean;
   ...
   *
   * @generated from field: string blocking_reason = 3;
   */
  ...
  /**
   * @generated from field: int32 normal = 5;
   */
  normal: number;
  ...
  /**
   * @generated from field: int32 unsupported = 8;
   */
  unsupported: number;

  /**
   * @generated from field: memos.api.v1.MemoImportSkippedCounts skipped = 9;
   */
  skipped?: MemoImportSkippedCounts | undefined;

  /**
   * @generated from field: repeated memos.api.v1.MemoImportIssue issues = 10;
   */
  issues: MemoImportIssue[];

  /**
   * @generated from field: string source_user = 11;
   */
  sourceUser: string;

  /**
   * @generated from field: string exported_at = 12;
   */
  exportedAt: string;
};

/**
 * Describes the message memos.api.v1.MemoImportPreview.
 * Use `create(MemoImportPreviewSchema)` to create a new message.
 */
export const MemoImportPreviewSchema: GenMessage<MemoImportPreview> = /*@__PURE__*/
  messageDesc(file_api_v1_memo_service, 37);

/**
 * @generated from message memos.api.v1.MemoImportResult
 */
export type MemoImportResult = Message<"memos.api.v1.MemoImportResult"> & {
  /**
   * @generated from field: int32 restored = 1;
   */
  restored: number;

  /**
   * @generated from field: int32 skipped_total = 2;
   */
  skippedTotal: number;
  ...
  /**
   * @generated from field: int32 normal = 4;
   */
  normal: number;

  /**
   * @generated from field: int32 archived = 5;
   */
  archived: number;

  /**
   * @generated from field: memos.api.v1.MemoImportSkippedCounts skipped = 6;
   */
  skipped?: MemoImportSkippedCounts | undefined;
...
/**
 * Describes the message memos.api.v1.MemoImportResult.
 * Use `create(MemoImportResultSchema)` to create a new message.
 */
export const MemoImportResultSchema: GenMessage<MemoImportResult> = /*@__PURE__*/
...
/**
 * @generated from enum memos.api.v1.MemoImportIssueKind
 */
export enum MemoImportIssueKind {
  /**
   * @generated from enum value: MEMO_IMPORT_ISSUE_KIND_UNSPECIFIED = 0;
   */
...
/**
 * Describes the enum memos.api.v1.MemoImportIssueKind.
 */
export const MemoImportIssueKindSchema: GenEnum<MemoImportIssueKind> = /*@__PURE__*/
...
export const MemoService: GenService<{
   ...
   *
   * @generated from rpc memos.api.v1.MemoService.PreviewMemoImport
   */
  previewMemoImport: {
    methodKind: "unary";
    input: typeof PreviewMemoImportRequestSchema;
    output: typeof MemoImportPreviewSchema;
  },
  /**
   * ImportMemoExport restores supported memo fields from a MemoArk v1 export.
   *
   * @generated from rpc memos.api.v1.MemoService.ImportMemoExport
   */
  importMemoExport: {
    methodKind: "unary";
    input: typeof ImportMemoExportRequestSchema;
    output: typeof MemoImportResultSchema;
  },
  /**
