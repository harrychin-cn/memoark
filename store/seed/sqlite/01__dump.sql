...
-- 9. Project Disclosure Memo (Pinned) — replaces upstream sponsorship content with MemoArk's own disclosure
INSERT INTO memo (id,uid,creator_id,content,visibility,pinned,payload) VALUES(9,'disclosure0001',1,replace('## MemoArk project disclosure / 项目披露\n\nThis demo content is not sponsored and contains no paid placement or affiliate links. Companies supporting the upstream Memos project are not automatically MemoArk sponsors, and MemoArk receives no compensation from those upstream relationships.\n\n本演示内容不含赞助、付费展示或推广返佣链接。赞助上游 Memos 项目的公司不会因此自动成为 MemoArk 的赞助方，MemoArk 不会从这些上游赞助关系中获得报酬。\n\nAny future paid, sponsored, or affiliate content maintained by the MemoArk project must be clearly labelled where it appears and identify who benefits. See `docs/ADVERTISING.md` in the source repository.\n\nMemoArk 项目未来维护的任何付费、赞助或推广返佣内容，都必须在内容实际展示的位置清楚标注，并说明受益方。详见源代码仓库中的 `docs/ADVERTISING.md`。\n\n#memoark #disclosure','\n',char(10)),'PUBLIC',1,'{"tags":["memoark","disclosure"],"property":{"hasLink":false}}');
...
INSERT INTO reaction (id,creator_id,content_id,reaction_type) VALUES(7,1,'memos/disclosure0001','🚀');
INSERT INTO reaction (id,creator_id,content_id,reaction_type) VALUES(8,2,'memos/disclosure0001','👍');
