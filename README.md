...
<p align="center">
  ...
  · <a href="docs/user-guide-zh-CN.md">中文说明</a> | <a href="docs/user-guide-en.md">English Guide</a>
...
安装、编辑、附件、分享、备份、升级和排错请查看 [中文说明](docs/user-guide-zh-CN.md) | [English Guide](docs/user-guide-en.md)。
...
CycloneDX SBOMs. See the [English Guide](docs/user-guide-en.md) or [中文说明](docs/user-guide-zh-CN.md) for end-user instructions.
