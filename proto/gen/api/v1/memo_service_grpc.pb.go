...
const (
	...
	MemoService_PreviewMemoImport_FullMethodName    = "/memos.api.v1.MemoService/PreviewMemoImport"
	MemoService_ImportMemoExport_FullMethodName     = "/memos.api.v1.MemoService/ImportMemoExport"
...
type MemoServiceClient interface {
	...
	PreviewMemoImport(ctx context.Context, in *PreviewMemoImportRequest, opts ...grpc.CallOption) (*MemoImportPreview, error)
	// ImportMemoExport restores supported memo fields from a MemoArk v1 export.
	ImportMemoExport(ctx context.Context, in *ImportMemoExportRequest, opts ...grpc.CallOption) (*MemoImportResult, error)
...
func (c *memoServiceClient) PreviewMemoImport(ctx context.Context, in *PreviewMemoImportRequest, opts ...grpc.CallOption) (*MemoImportPreview, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(MemoImportPreview)
	err := c.cc.Invoke(ctx, MemoService_PreviewMemoImport_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *memoServiceClient) ImportMemoExport(ctx context.Context, in *ImportMemoExportRequest, opts ...grpc.CallOption) (*MemoImportResult, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(MemoImportResult)
	err := c.cc.Invoke(ctx, MemoService_ImportMemoExport_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type MemoServiceServer interface {
	...
	// PreviewMemoImport validates a MemoArk v1 export without writing data.
	PreviewMemoImport(context.Context, *PreviewMemoImportRequest) (*MemoImportPreview, error)
	// ImportMemoExport restores supported memo fields from a MemoArk v1 export.
	ImportMemoExport(context.Context, *ImportMemoExportRequest) (*MemoImportResult, error)
	// ListMemos lists memos with pagination and filter.
...
func (UnimplementedMemoServiceServer) PreviewMemoImport(context.Context, *PreviewMemoImportRequest) (*MemoImportPreview, error) {
	return nil, status.Error(codes.Unimplemented, "method PreviewMemoImport not implemented")
}
func (UnimplementedMemoServiceServer) ImportMemoExport(context.Context, *ImportMemoExportRequest) (*MemoImportResult, error) {
	return nil, status.Error(codes.Unimplemented, "method ImportMemoExport not implemented")
}
...
func _MemoService_PreviewMemoImport_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(PreviewMemoImportRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(MemoServiceServer).PreviewMemoImport(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: MemoService_PreviewMemoImport_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MemoServiceServer).PreviewMemoImport(ctx, req.(*PreviewMemoImportRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _MemoService_ImportMemoExport_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ImportMemoExportRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(MemoServiceServer).ImportMemoExport(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: MemoService_ImportMemoExport_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MemoServiceServer).ImportMemoExport(ctx, req.(*ImportMemoExportRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var MemoService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "PreviewMemoImport",
			Handler:    _MemoService_PreviewMemoImport_Handler,
		},
		{
			MethodName: "ImportMemoExport",
			Handler:    _MemoService_ImportMemoExport_Handler,
		},
		{
